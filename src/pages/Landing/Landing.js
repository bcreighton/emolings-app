        ...
        return (
            <div className="landing">
                ...
                <section className="container value-prop">
                    ...
                    <p className="support-copy">Feeling charts are a thing of the past; unfortuantely, they're limited as they're static and although their purpose and intent of feeling identification is decent it doesn't solve the root of the problem.<span className='emphasized'>CONVERSATION & COPING MECHANISMS!</span></p>
                    <p className="support-copy">Emolings is a modern age version of a feelings chart.</p>
                    <p className="support-copy">Not only does Emolings provide emotion and feeling identification, both from the Parent/Caregiver and Child perspective; but Emolings also provides the next steps which are the most essential.</p>
                ...
                <section className="container">
                    <h2 className="section-head">A Note To Parents and Caregivers</h2>
